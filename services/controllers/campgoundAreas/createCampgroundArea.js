 ...
 */
const createCampgroundArea = async (req, res) => {
    ...
    if (!doesCampgroundAreaExists) {
      ...
      for (let i = 1; i <= createSiteCnt; i++) {
        ...
        const siteData = {
          ...
          peopleMaxCnt: 0, // 최대인원
          peopleStdCnt: 0, // 기준인원
          peopleAdultStdCnt: 0, // 기준성인
          peopleAdultMaxCnt: 0, // 최대성인
          peopleKidStdCnt: 0, // 기준소인
          peopleKidMaxCnt: 0, // 최대성인
      ...
      const createdCampgroundAreaObject = createdCampgroundArea.toObject()
...
module.exports = { createCampgroundArea }
